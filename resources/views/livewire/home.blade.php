<div>
    ...
    <section class="bg-primary-50 py-14">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h2 class="text-2xl md:text-3xl font-black text-primary-900 mb-4">{{ brand_name() }} au service de votre métier</h2>
            @if (brand_meta_description())
                <p class="text-neutral-700 leading-relaxed">{{ brand_meta_description() }}</p>
            @endif
            <div class="mt-6">
                <x-ui.button variant="primary" href="/pages/qui-sommes-nous" size="lg">En savoir plus →</x-ui.button>
            </div>
        </div>
    </section>
    ...
    <section class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="flex items-end justify-between mb-6">
            <h2 class="text-2xl md:text-3xl font-black text-neutral-900">Actualités</h2>
