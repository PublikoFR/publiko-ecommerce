...
return [
    ...
    'resources' => [
        ...
        base_path('packages/pko/catalog-features/src/Models'),
        base_path('packages/pko/product-documents/src/Models'),
        base_path('packages/pko/product-videos/src/Models'),
        base_path('packages/pko/storefront-cms/src/Models'),
        base_path('packages/pko/store-locator/src/Models'),
    ],
