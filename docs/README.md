...
- [mail-templates.md](packages/mail-templates.md) — e-mails transactionnels éditables en back-office (client + équipe) + déclencheurs du parcours commande ; texte par défaut revu → migration `DefaultContentUpgrade`
