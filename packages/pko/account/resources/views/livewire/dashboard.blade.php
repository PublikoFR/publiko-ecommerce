<div>
    <h1 class="font-display font-bold text-2xl md:text-3xl text-neutral-900 mb-2">Bonjour {{ $user?->name }}</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
        <x-ui.card class="text-center" padding="lg">
            ...
            <p class="font-display font-bold text-3xl text-neutral-900">{{ $recentOrders->count() }}</p>
        ...
        <x-ui.card class="text-center" padding="lg">
            ...
            <p class="font-display font-bold text-3xl text-neutral-900">—</p>
    ...
    <x-ui.card padding="lg">
        <div class="flex items-center justify-between mb-4">
            <h2 class="font-display font-bold text-lg text-neutral-900">Commandes récentes</h2>
