...
class OrderPolicy
{
    ...
    {
        return $staff->can('view_any_order');
    }
    ...
    {
        return $staff->can('delete_any_order');
    }
    ...
    {
        return $staff->can('force_delete_order');
    }
    ...
    {
        return $staff->can('force_delete_any_order');
    }
    ...
    {
        return $staff->can('restore_order');
    }
    ...
    {
        return $staff->can('restore_any_order');
    }

    /**
     * Determine whether the staff can replicate.
     */
    public function replicate(Staff $staff, Order $order): bool
    {
        return $staff->can('replicate_order');
    }
    ...
    {
        return $staff->can('reorder_order');
    }
}
