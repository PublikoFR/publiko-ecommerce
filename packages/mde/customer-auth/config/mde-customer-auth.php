...
return [
    ...
    'default_customer_group_handle' => env('MDE_DEFAULT_PRO_GROUP_HANDLE', 'installateurs'),

    'admin_notification_email' => env('MDE_ADMIN_NOTIFICATION_EMAIL', env('MDE_CONTACT_EMAIL')),
