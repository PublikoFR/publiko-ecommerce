        ...
        <div class="p-6 space-y-4">
            <div class="flex gap-4">
                <button @class([
                    ...
                    'text-neutral-500 hover:text-neutral-700' => $paymentType !== 'card',
                ])
                        type="button"
            ...
            @if ($paymentType == 'cash-in-hand')
                <form wire:submit="checkout">
                    <div class="p-4 text-sm text-center text-info-700 rounded-lg bg-info-50">
                        Paiement hors ligne, aucune carte requise.
                    </div>

                    <button class="px-5 py-3 mt-4 text-sm font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700"
                            type="submit"
