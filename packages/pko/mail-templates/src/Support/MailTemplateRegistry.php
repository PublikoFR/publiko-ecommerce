    ...
    public static function all(): array
    {
        return [
            ...
            'account.registered_admin' => [
                ...
                'label' => 'Nouvelle inscription (équipe)',
                'placeholders' => [
                    'company_name',
                    'contact_name',
                    'email',
            ...
            'order.placed_admin' => [
                'group' => 'order',
                'audience' => self::AUDIENCE_ADMIN,
                'label' => 'Nouvelle commande (équipe)',
                'placeholders' => [
                    'company_name',
                    'contact_name',
                    'email',
                ...
                'required' => ['order_reference', 'admin_url'],
            ],
            'order.payment_offline_admin' => [
                'group' => 'order',
                'audience' => self::AUDIENCE_ADMIN,
                'label' => 'Paiement virement (équipe)',
                'placeholders' => [
                    'company_name',
                    'contact_name',
                    'email',
            ...
            'loyalty.tier_unlocked_admin' => [
                'group' => 'loyalty',
                'audience' => self::AUDIENCE_ADMIN,
                'label' => 'Palier de fidélité (équipe)',
                'placeholders' => [
                    'company_name',
                    'contact_name',
                    'email',
