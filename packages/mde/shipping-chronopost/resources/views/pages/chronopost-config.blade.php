    ...
    <div class="space-y-6">
        ...
        <x-filament::section>
            ...
            <x-slot name="description">
                Credentials API, services activés et grille tarifaire.
            </x-slot>
            ...
            @if ($this->isConfigured())
                <div class="flex items-start gap-3 rounded-lg bg-success-50 p-4 dark:bg-success-500/10">
                    ...
                    <div>
                        <p class="font-semibold text-success-700 dark:text-success-300">Chronopost est configuré</p>
                        <p class="mt-1 text-sm text-success-700/80 dark:text-success-300/80">
                            Compte et mot de passe présents. Cliquez sur « Tester les credentials » pour valider.
                        </p>
                    </div>
                </div>
            @else
                <div class="flex items-start gap-3 rounded-lg bg-warning-50 p-4 dark:bg-warning-500/10">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-warning-700/80 dark:text-warning-300/80">
                            Renseignez <code>CHRONOPOST_ACCOUNT</code> et <code>CHRONOPOST_PASSWORD</code> dans <code>.env</code>.
                        </p>
                    </div>
                </div>
            @endif
        ...
        <x-filament::section>
            ...
            <div class="divide-y divide-gray-100 dark:divide-white/5">
                <div class="flex items-center justify-between gap-4 py-3 first:pt-0">
                    <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">
                            Compte (<code>CHRONOPOST_ACCOUNT</code>)
                        </p>
                        <p class="mt-0.5 font-mono text-xs text-gray-500 dark:text-gray-400">
                            {{ $this->hasAccount() ? $this->getAccount() : 'Non renseigné' }}
                        </p>
                    </div>
                    @if ($this->hasAccount())
                ...
                <div class="flex items-center justify-between gap-4 py-3">
                    <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">
                            Mot de passe (<code>CHRONOPOST_PASSWORD</code>)
                        </p>
                        <p class="mt-0.5 font-mono text-xs text-gray-500 dark:text-gray-400">
                ...
                <div class="flex items-center justify-between gap-4 py-3 last:pb-0">
                    <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white">
                            Sous-compte (<code>CHRONOPOST_SUB_ACCOUNT</code>)
                        </p>
                        <p class="mt-0.5 font-mono text-xs text-gray-500 dark:text-gray-400">
                            {{ $this->getSubAccount() ?: '—' }}
                        </p>
        ...
        <x-filament::section>
            ...
            <x-slot name="description">
                Liste des produits Chronopost proposés au checkout. Modifiez via <code>config/chronopost.php</code>.
            </x-slot>
        ...
        <x-filament::section>
            ...
            <x-slot name="description">
                Paliers de poids (France métropolitaine). Valeurs statiques, swap possible vers l'API QuickCost en v2.
            </x-slot>
