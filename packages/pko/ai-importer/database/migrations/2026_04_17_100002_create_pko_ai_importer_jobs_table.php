...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('pko_ai_importer_jobs', function (Blueprint $table) use ($prefix): void {
            $table->id();
            $table->uuid('uuid')->unique();

            $table->foreignId('config_id')
                ->nullable()
                ->constrained('pko_ai_importer_configs')
                ->nullOnDelete();
    ...
    {
        Schema::dropIfExists('pko_ai_importer_jobs');
    }
};
