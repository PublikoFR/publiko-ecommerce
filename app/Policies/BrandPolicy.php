...
class BrandPolicy
{
    ...
    {
        return $staff->can('view_any_brand');
    }

    /**
     * Determine whether the staff can view the model.
     */
    public function view(Staff $staff, Brand $brand): bool
    {
        return $staff->can('view_brand');
    }
    ...
    {
        return $staff->can('create_brand');
    }

    /**
     * Determine whether the staff can update the model.
     */
    public function update(Staff $staff, Brand $brand): bool
    {
        return $staff->can('update_brand');
    }

    /**
     * Determine whether the staff can delete the model.
     */
    public function delete(Staff $staff, Brand $brand): bool
    {
        return $staff->can('delete_brand');
    }
    ...
    {
        return $staff->can('delete_any_brand');
    }

    /**
     * Determine whether the staff can permanently delete.
     */
    public function forceDelete(Staff $staff, Brand $brand): bool
    {
        return $staff->can('force_delete_brand');
    }
    ...
    {
        return $staff->can('force_delete_any_brand');
    }

    /**
     * Determine whether the staff can restore.
     */
    public function restore(Staff $staff, Brand $brand): bool
    {
        return $staff->can('restore_brand');
    }
    ...
    {
        return $staff->can('restore_any_brand');
    }

    /**
     * Determine whether the staff can replicate.
     */
    public function replicate(Staff $staff, Brand $brand): bool
    {
        return $staff->can('replicate_brand');
    }
    ...
    {
        return $staff->can('reorder_brand');
    }
}
