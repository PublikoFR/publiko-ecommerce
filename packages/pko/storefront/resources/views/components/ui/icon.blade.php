...
$icons = [
    ...
    'star' => '<path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.5a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z"/>',
    ...
    'badge-check' => '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z"/>',
    ...
    'rows' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 5.25h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5"/>',
    'package' => '<path stroke-linecap="round" stroke-linejoin="round" d="m7.5 4.27 9 5.15M21 8.25V15.75a2.25 2.25 0 0 1-1.125 1.948l-6.75 3.9a2.25 2.25 0 0 1-2.25 0l-6.75-3.9A2.25 2.25 0 0 1 3 15.75V8.25a2.25 2.25 0 0 1 1.125-1.948l6.75-3.9a2.25 2.25 0 0 1 2.25 0l6.75 3.9A2.25 2.25 0 0 1 21 8.25Zm-9 3.75L3.27 6.96m8.73 5.04 8.73-5.04M12 12v9.75"/>',
    ...
    'headset' => '<path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12a7.5 7.5 0 0 1 15 0m-15 0v3a1.5 1.5 0 0 0 1.5 1.5H7.5V12H6a1.5 1.5 0 0 0-1.5 0Zm15 0v3a1.5 1.5 0 0 1-1.5 1.5H18v3a1.5 1.5 0 0 1-1.5 1.5H12m7.5-9H18a1.5 1.5 0 0 0-1.5 1.5v3H18a1.5 1.5 0 0 0 1.5-1.5"/>',
