...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('pko_ai_importer_staging', function (Blueprint $table) use ($prefix): void {
            $table->id();
            ...
            $table->index(['import_job_id', 'status'], 'pko_staging_job_status_idx');
    ...
    {
        Schema::dropIfExists('pko_ai_importer_staging');
    }
};
