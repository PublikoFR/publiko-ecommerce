...
class CarrierProductCodeResolverTest extends TestCase
{
    ...
    public function test_les_migrations_renseignent_les_codes_produits_chronopost(): void
    {
        ...
        $this->assertSame('2', $resolver->resolve('chronopost', 'chrono10'));
    ...
    {
        config(['chronopost.product_codes.chrono10' => '2']);

        $this->setProductCode('chrono10', null);

        $this->assertSame('2', (new CarrierProductCodeResolver)->resolve('chronopost', 'chrono10'));
    }
