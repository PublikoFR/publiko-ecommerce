    ...
    <article class="py-8 md:py-12">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <header class="mb-8">
                ...
                @endif
                @php
                    $onPageH1 = trim((string) data_get($post->content, 'heading')) ?: $post->title;
                @endphp
                <h1 class="text-3xl md:text-4xl font-display font-bold text-neutral-900 leading-tight">{{ $onPageH1 }}</h1>
                @if ($post->excerpt)
